...
$(document).ready(function() {
	...
	$("#button-forms-product-create").click(function(event) {
	...
	request.done(function(products) {
		...
		for(var i=0; i < products.length; i++){
			...
			table.row.add([
				...
				'<button onclick="javascript:deleteCustomer(' + products[i].id + ',\'' + products[i].name + '\');" type="button" class="btn btn-secondary" id="button-customer-delete"><div class="icon"><i class="bx bxs-eraser"></i></div></button>',				
				""
			]);
		}
